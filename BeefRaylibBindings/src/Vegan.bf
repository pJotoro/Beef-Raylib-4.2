// NOTE(pJotoro): It is recommended that you do not use anything in Vegan.bf, since it is all functionality
// better supported by core-lib. That said, if for whatever reason you really want to use these functions,
// you absolutely can as they are all public, they just don't show up in auto-completion with the NowShow
// attribute.
